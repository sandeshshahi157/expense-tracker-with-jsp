...
<%
    // Assuming you have predefined expense types
    List<String> expense_type = new ArrayList<>();
        expense_type.add("Select expense type");
    expense_type.add("Food");
    expense_type.add("Clothes");
    expense_type.add("College Fee");
    expense_type.add(" Transpotation");
       expense_type.add("Entertainment");
          expense_type.add(" Transpotation");
%>
<!DOCTYPE html>
<html lang="en">
    ...
    function validateForm() {
        ...
        // Validate Expense
        if (expense === '') {
            displayErrorMessage("Expense is required.", "expense-error");
            return false;
        }

        // Validate Amount
        if (amount === '') {
            displayErrorMessage("Amount is required.", "amount-error");
            return false;
        }

        // Validate Expense Type
        if (expenseType === '') {
            displayErrorMessage("Expense Type is required.", "expense-type-error");
            return false;
        }
        if(expenseType==='Select expense type')
        {
             displayErrorMessage("Expense Type is required.", "expense-type-error");
            return false;
        ...
        if (!dateRegex.test(date)) {
            displayErrorMessage("Date is required", "date-error");
            return false;
        }
        ...
        if (description === '') {
            displayErrorMessage("Description is required.", "description-error");
            return false;
        }
    ...
    function displayErrorMessage(message, fieldId) {
        ...
        // Display error message below the corresponding input field
    ...
    function validateDate() {
        ...
        if (selectedDate > currentDate) {
            displayErrorMessage("Date cannot be in the future.", "date-error");
            return false;
        } else {
            return true;
        }
    ...
    <body class="font-mono dark:bg-darker">
        <div x-data="setup()" x-init="$refs.loading.classList.add('hidden'); setColors(color);" :class="{ 'dark': isDark}">
            <div class="flex h-screen antialiased text-gray-900 bg-gray-100 dark:bg-dark dark:text-light">
                ...
                <div class="flex-1 h-screen dark:bg-darker " >
                    ...
                    <main class="h-full font-mono dark:bg-darker">
                        <!-- Content header -->
                        <div class="flex items-center justify-between px-4 py-4 border-b lg:py-6 dark:border-primary-darker">
                            <h1 class="text-2xl font-semibold">Add Expense</h1>
                        ...
                        <div class="addExpense p-5 dark:bg-darker ">
                          <div class="form">
    <form action="/AddExpenseServlet" method="post" onsubmit="return validateForm();">
        <div class="mb-6" id="form-error"></div>

        <label for="expense" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Title</label>
        <input type="text" id="expense" name="expense" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Expense">
        <div class="mb-6" id="expense-error"></div>

        <label for="amount" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Expense Amount(Rs.)</label>
        <input type="text" id="amount" name="amount" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Amount in ($.00)">
        <div class="mb-6" id="amount-error"></div>

        <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Select Type of Expense</label>
        <select id="expense_type" name="expense_type" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
            <% for (String type : expense_type) { %>
                <option value="<%= type %>"><%= type %></option>
            <% } %>
        </select>
        <div class="mb-6" id="expense-type-error"></div>

        <label for="date" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Date of Expense</label>
        <div class="relative max-w-sm">
            ...
            <input type="date" name="date" id="date" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date">
            <div class="mb-6 text-red-500" id="date-error"></div>
        </div>

        <label for="description" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Description</label>
        <div class="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
            <div class="px-4 py-2 bg-white rounded-t-lg dark:bg-gray-800">
                <textarea id="description" name="description" rows="4" class="focus:outline-none w-full px-0 text-sm text-gray-900 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write a comment..."></textarea>
            </div>
        </div>
        <div class="mb-6" id="description-error"></div>
        <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
    </form>
</div>


                            <div class="dark:bg-darker h-full mt-5">
