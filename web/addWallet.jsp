<%-- 
    Document   : addWallet
    Created on : 29-Jan-2024, 8:37:29 am
    Author     : hackeath
--%>
...
<%
    ...
    try {
        ...
        ResultSet tables = dbMetaData.getTables(null, null, loggedInUser, null);
...
%>
            ...
            <div class="flex items-center justify-between px-4 py-4 border-b lg:py-6 dark:border-primary-darker">
                <h1 class="text-2xl font-semibold">No Expenses Yet</h1>
            </div>

            <p class="text-center mt-4 text-gray-600">You haven't added any expenses yet. Start adding expenses to see them here.</p>
<%
        } else {
            // Retrieve all expenses for the logged-in user
            String selectQuery = "SELECT * FROM " + loggedInUser + " ORDER BY date DESC";
            pstmt = conn.prepareStatement(selectQuery);
            resultSet = pstmt.executeQuery();
%>
            <!-- Content header -->
            <div class="flex items-center justify-between px-4 py-4 border-b lg:py-6 dark:border-primary-darker">
                <h1 class="text-2xl font-semibold">Your Expenses</h1>
            </div>

            <div class="overflow-x-auto">
                <table class="min-w-full border-none border-collapse border-gray-300 overflow-hidden">
                    ...
                    <tbody class="bg-gray-100">
                        <% while (resultSet.next()) { %>
                            <tr class="hover:bg-gray-300">
                                <td class="py-2 px-4 border-b"><%= resultSet.getString("expense") %></td>
                                <td class="py-2 px-4 border-b"><%= resultSet.getDouble("amount") %></td>
                                <td class="py-2 px-4 border-b"><%= resultSet.getString("description") %></td>
                                <td class="py-2 px-4 border-b"><%= resultSet.getString("date") %></td>
                                <td class="py-2 px-4 border-b">
                                    <!-- Add links/buttons for delete and edit actions -->
                                    <a href="deleteExpense.jsp?id=<%= resultSet.getInt("id") %>"
                                        class="text-red-500 hover:text-red-900">Delete</a>
                                    &nbsp;&nbsp;
                                    <a href="editExpense.jsp?id=<%= resultSet.getInt("id") %>"
